...
class Environment {
  ...
  static String get dailyForecastAPIPath => dotenv.env['DAILY_FORECAST_API_PATH'] ?? '';
  static String get hourlyForecastAPIPath => dotenv.env['HOURLY_FORECAST_API_PATH'] ?? '';
  ...
  static String get hourlyForecastBaseURL => apiEndpoint + hourlyForecastAPIPath;
  static String get dailyForecastBaseURL => apiEndpoint + dailyForecastAPIPath;
